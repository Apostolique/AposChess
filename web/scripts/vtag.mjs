...
// Elo on the SAME hc6-pinned scale the rank ledger uses (the pin's value is per search era —
// PIN_ELO_BY_ERA in depth-ladder.mjs — so the scale survives a search change). Consumers read the strength
